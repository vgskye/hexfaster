...
fun drawPatternFromPoints(
    ...
    for (node in nodes) {
        drawSpot(
            ...
            node,
            2f,
            dodge(ARGB32.red(head)) / 255f,
            dodge(ARGB32.green(head)) / 255f,
            dodge(ARGB32.blue(head)) / 255f,
            ARGB32.alpha(head) / 255f
        )
    }
}
...
fun screenCol(n: Int): Int {
    return FastColor.ARGB32.color(
        ...
        screen(ARGB32.red(n)),
        screen(ARGB32.green(n)),
        screen(ARGB32.blue(n)),
    )
}
